...
<body>
  ...
  <div class="container-fluid m-0 p-0">
    <div class="row g-0">
      <div class="col-sm-12 col-md-4 d-flex justify-content-center">
        <img src="images/Gallery/DinnerRoom_sq.jpg"
        class="w-75 shadow-1-strong rounded m-4 img-fluid" alt="Dinner Room"/>
      </div>
      <div class="col-sm-12 col-md-4 d-flex justify-content-center">
        <img src="images/Gallery/Preparation_sq.jpg"
        class="w-75 shadow-1-strong rounded m-4 img-fluid" alt="Table Preparation"/>
      </div>
      <div class="col-sm-12 col-md-4 d-flex justify-content-center">
        <img src="images/Gallery/Service_sq.jpg"
        class="w-75 shadow-1-strong rounded m-4 img-fluid" alt="Service"/>
      </div>
    </div>
  </div>
  ...
  <nav aria-label="...">
    <ul class="pagination justify-content-center">
      <li class="page-item"><a class="notactive page-link">Previous</a></li>

      <li class="page-item active" aria-current="page"><a class="page-link text-white" href="#"><span class="pagebtn">1</span></a></li>
      ...
      <li class="page-item"><a class="page-link text-white" href="pictures2.php"><span class="pagebtn">Next</span></a></li>
    </ul>
  </nav>
