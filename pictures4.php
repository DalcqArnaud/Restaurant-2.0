...
<body>
  ...
  <div class="container-fluid m-0 p-0">
    <div class="row g-0 d-flex justify-content-center">
      <div class="col-sm-12 col-md-4 d-flex justify-content-center">
        <img src="images/Gallery/Wine_sq.jpg"
        class="w-75 shadow-1-strong rounded m-4 img-fluid" alt="Wine"/>
      </div>
    </div>
  </div>
  ...
  <nav aria-label="...">
    <ul class="pagination justify-content-center">
      <li class="page-item"><a class="page-link text-white" href="pictures3.php"><span class="pagebtn">Previous</span></a></li>
      ...
      <li class="page-item active" aria-current="page"><a class="page-link text-white" href="#"><span class="pagebtn">4</span></a></li>

      <li class="page-item"><a class="notactive page-link">Next</a></li>
    </ul>
  </nav>
