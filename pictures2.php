...
<body>
  ...
  <div class="container-fluid m-0 p-0">
    <div class="row g-0">
      <div class="col-sm-12 col-md-4 d-flex justify-content-center">
        <img src="images/Gallery/Pizzas_sq.jpg"
        class="w-75 shadow-1-strong rounded m-4 img-fluid" alt="Pizza"/>
      </div>
      <div class="col-sm-12 col-md-4 d-flex justify-content-center">
        <img src="images/Gallery/Bread_sq.jpg"
        class="w-75 shadow-1-strong rounded m-4 img-fluid" alt="Bread"/>
      </div>
      <div class="col-sm-12 col-md-4 d-flex justify-content-center">
        <img src="images/Gallery/FruitCake_sq.jpg"
        class="w-75 shadow-1-strong rounded m-4 img-fluid" alt="Fruit Cake"/>
      </div>
    </div>
  </div>
  ...
  <nav aria-label="...">
    <ul class="pagination justify-content-center">
      <li class="page-item"><a class="page-link text-white" href="pictures.php"><span class="pagebtn">Previous</span></a></li>

      <li class="page-item"><a class="page-link text-white" href="pictures.php"><span class="pagebtn">1</span></a></li>
      <li class="page-item active" aria-current="page"><a class="page-link text-white" href="#"><span class="pagebtn">2</span></a></li>
      <li class="page-item"><a class="page-link text-white" href="pictures3.php"><span class="pagebtn">3</span></a></li>
      <li class="page-item"><a class="page-link text-white" href="pictures4.php"><span class="pagebtn">4</span></a></li>

      <li class="page-item"><a class="page-link text-white" href="pictures3.php"><span class="pagebtn">Next</span></a></li>
    </ul>
  </nav>
